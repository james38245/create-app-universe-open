...
import { Star, MapPin, Phone, MessageSquare, Eye, Calendar, DollarSign, FileText } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';
import PublicDocuments from '@/components/profile/PublicDocuments';
  ...
  if (layout === 'list') {
    return (
      <div className="space-y-4">
        ...
        {showDocuments && (
          <PublicDocuments userId={provider.user_id} showTitle={false} />
        )}
      </div>
    );
  }
